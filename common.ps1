...
$list = @{
    ...
    gui                    = "\gui\"
    ГенераторДокументацииДляПарсера = "\plugins\ГенераторДокументацииДляПарсера\"
    ГенераторИсходногоКодаПоАСД = "\plugins\ГенераторИсходногоКодаПоАСД\"
    ДетекторФункцийБезВозвратаВКонце = "\plugins\ДетекторФункцийБезВозвратаВКонце\"
    ДетекторНеиспользуемыхПеременных = "\plugins\ДетекторНеиспользуемыхПеременных\"
    ДетекторОшибочныхЗамыкающихКомментариев = "\plugins\ДетекторОшибочныхЗамыкающихКомментариев\"
    РекурсивныйПодсчетСерверныхВызововВМодуляхФорм = "\plugins\РекурсивныйПодсчетСерверныхВызововВМодуляхФорм\"
    ПодсчетКогнитивнойСложностиМетодов = "\plugins\ПодсчетКогнитивнойСложностиМетодов\"
    ПримерМодификацииИсходногоКода = "\plugins\ПримерМодификацииИсходногоКода\"
