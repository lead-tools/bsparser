...
$list = @{
    ...
    ОптимизаторПарсера                             = "\plugins\ОптимизаторПарсера\src"
    ...
    ПроверкаКаноничностиКлючевыхСлов               = "\plugins\ПроверкаКаноничностиКлючевыхСлов\src"
    ДетекторПропущенныхТочекСЗапятой               = "\plugins\ДетекторПропущенныхТочекСЗапятой\src"
    РасстановкаПропущенныхТочекСЗапятой            = "\plugins\РасстановкаПропущенныхТочекСЗапятой\src"
    ЗаменаНеканоничныхКлючевыхСлов                 = "\plugins\ЗаменаНеканоничныхКлючевыхСлов\src"
}
