...
Процедура ВставитьОбъект(Имя, Доступность)
	Переменные.Вставить(Имя, Парсер.ЭлементОкружения(Имя, Парсер.ГлобальныйОбъект(Имя, Доступность)));
КонецПроцедуры // ВставитьОбъект()

Процедура ВставитьМетод(Имя, ВозвращаетЗначение, Параметры, Доступность)
	Методы.Вставить(Имя, Парсер.ЭлементОкружения(Имя, Парсер.ГлобальныйМетод(Имя, ВозвращаетЗначение, Параметры, Доступность)));
