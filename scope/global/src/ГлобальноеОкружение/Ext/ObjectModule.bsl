...
Процедура ВставитьОбъект(Имя, Доступность)
	Переменные.Вставить(Имя, Парсер.ЭлементОкружения(Имя, Парсер.ОбъявлениеГлобальногоОбъекта(Имя, Доступность)));
КонецПроцедуры // ВставитьОбъект()

Процедура ВставитьМетод(Имя, ВозвращаетЗначение, Параметры, Доступность)
	Методы.Вставить(Имя, Парсер.ЭлементОкружения(Имя, Парсер.ОбъявлениеГлобальногоМетода(Имя, ВозвращаетЗначение, Параметры, Доступность)));
