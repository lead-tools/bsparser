Write-Progress -Activity "Build" -Status "$I% Complete:" -PercentComplete 0
...
Write-Progress -Activity "Build" -Status "$I% Complete:" -PercentComplete 100