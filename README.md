...
* /gui - исходники обработки-консоли, предоставляющей графический пользовательский интерфейс к парсеру (в целях отладки)
...
* /plugins - исходники обработок-плагинов (это просто примеры для изучения, а не боевые диагностики)
