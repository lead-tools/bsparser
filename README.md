...
2. Открыть обработку build/gui.epf в управляемом приложении любой файловой базы (обработка BSParser.epf должна лежать рядом с gui.epf)
...
* Парсер - обработка BSParser из этого репозитория
