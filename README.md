...
**Внимание! Разыскивается мейнтейнер-энтузиаст для данного проекта. Автору наскучила платформа 1С и он ушел играть в питон:** https://github.com/tsukanov-as/bslinter

**Пишите мне на почту (в профиле):** https://github.com/tsukanov-as
