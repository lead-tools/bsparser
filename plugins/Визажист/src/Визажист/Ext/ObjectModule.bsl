...
Функция Закрыть() Экспорт
	...
	Для НомерСтроки = 1 По КоличествоСтрок Цикл
		...
		Пока Индекс < КоличествоТокенов
			...
			Промежуток = Токен.Начало - Позиция;
			...
			Если КлючевыеСлова.Свойство(Токен.Токен) И ТаблицаТокенов[Индекс - 1].Токен <> Токены.Точка Тогда
				Добавить(Токен.Начало, Токен.Длина, "keyword");
			ИначеЕсли Токен.Токен = Токены.Комментарий Тогда	
				Добавить(Токен.Начало, Токен.Длина, "comment");
			ИначеЕсли Токен.Токен = Токены.Строка
				...
				Добавить(Токен.Начало, Токен.Длина, "string");
			ИначеЕсли Токен.Токен = Токены.Точка
				...
				Добавить(Токен.Начало, Токен.Длина, "special");
			Иначе	
				Добавить(Токен.Начало, Токен.Длина);
			КонецЕсли;
