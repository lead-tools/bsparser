...
Процедура ПосетитьОператорПрисваивания(ОператорПрисваивания, Stack, Счетчики) Экспорт
	...
	Если Идентификатор <> Неопределено Тогда 
		...
		Для Каждого Счетчик Из Счетчики Цикл 
			Если ИгнорируемыеСчетчики.Find(Счетчик.Ключ) = Неопределено Тогда 
		...
		КонецЦикла;
		Результат.Добавить(СтрШаблон("Message(%1); // Это вставлено плагином!!!", Идентификатор));
