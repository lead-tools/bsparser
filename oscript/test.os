...
Плагины.Add(Новый ДетекторНеиспользуемыхПеременных);
Плагины.Add(Новый ДетекторОшибочныхЗамыкающихКомментариев);
Плагины.Add(Новый ДетекторФункцийБезВозвратаВКонце);
